                ...
                <div class="card border-grey border-lighten-3 m-0">
                    <div class="card-header border-0">
                        <div class="card-title text-center">
                            <div class="p-1">
                                <img src="{{asset('assets/admin/images/logo-dark.png')}}" class="w-50" alt="LOGO"/>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal form-simple" action="{{route('admin.login')}}" method="post"
                                ...
                                <button type="submit" class="btn  btn-lg btn-block" style="background:#6fa828"><i class="ft-unlock"></i>
                                    دخول
                                </button>
                            </form>
                        </div>
